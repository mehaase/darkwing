...
class NmapXmlParser(xml.sax.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        """
        if name == "nmaprun":
            self._start_nmaprun(attrs)
        elif name == "scaninfo":
            self._start_scaninfo(attrs)
        elif name == "taskprogress":
            self._start_taskprogress(attrs)
        elif name == "host":
            self._start_host(attrs)
        elif name == "status":
            self._start_status(attrs)
        elif name == "address":
            self._start_address(attrs)
        elif name == "hostname":
            self._start_hostname(attrs)
        elif name == "extraports":
            self._start_extraports(attrs)
        elif name == "port":
            self._start_port(attrs)
        elif name == "state":
            self._start_state(attrs)
        elif name == "service":
            self._start_service(attrs)
        elif name == "cpe":
            self._start_cpe(attrs)
        elif name == "script":
            self._start_script(attrs)
        elif name == "elem":
            self._start_elem(attrs)
